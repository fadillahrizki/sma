...
<div class="container">
    <div class="navbar navbar-expand navbar-dark bg-info">
        <div class="navbar-nav m-auto">
            <a href="/" class="nav-link nav-item <?= !uri_string() ? 'active' : '' ?>">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-columns-gap" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                 <path fill-rule="evenodd" d="M6 1H1v3h5V1zM1 0a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H1zm14 12h-5v3h5v-3zm-5-1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5zM6 8H1v7h5V8zM1 7a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H1zm14-6h-5v7h5V1zm-5-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1h-5z"/>
                </svg>
                Dashboard
            </a>
            <?php if($this->session->user->level == "petugas"): ?>
            <a href="/stok" class="nav-link nav-item <?= uri_string() == 'stok' ? 'active' : '' ?>">
            ...
            <?php else: ?>
            <a href="/petugas" class="nav-link nav-item <?= uri_string() == 'petugas' ? 'active' : '' ?>">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-people-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                </svg>    
                Petugas
            </a>
            <a href="/trend_data" class="nav-link nav-item <?= uri_string() == 'trend_data' ? 'active' : '' ?>">
            ...
            <a href="/hasil_prediksi" class="nav-link nav-item <?= uri_string() == 'hasil_prediksi' ? 'active' : '' ?>">
            ...
            <?php endif ?>
            <a href="/auth/logout" class="nav-link nav-item">
                ...
                Keluar ( <?=$this->session->user->username?> )
            </a>
        </div>
    </div>
</div>
