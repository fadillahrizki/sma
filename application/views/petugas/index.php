    ...
    <div class="row">
        <div class="col-12">
            ...
            <?php if(isset($this->session->successCreate)): ?>
              <div class="alert alert-success">Berhasil Menambah Data Petugas</div>
            <?php unset($_SESSION['successCreate']);endif; ?>
            
            <?php if(isset($this->session->successUpdate)): ?>
              <div class="alert alert-success">Berhasil Mengedit Data Petugas</div>
            <?php unset($_SESSION['successUpdate']);endif; ?>
            
            <?php if(isset($this->session->successDelete)): ?>
              <div class="alert alert-success">Berhasil Menghapus Data Petugas</div>
              ...
              <tbody>
                ...
                <?php $no=1; foreach($data as $petugas): ?>
                  <tr>
                    ...
                    <td>
                      <a href="/petugas/edit?id=<?=$petugas->id?>" class="btn btn-warning btn-sm">
                      ...
                      <a href="/petugas/delete?id=<?=$petugas->id?>" class="btn btn-danger btn-sm">
